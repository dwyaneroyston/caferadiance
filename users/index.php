...
<html lang="en">
    ...
    <body>
        ...
        <header class="header">
            ...
            <nav class="navbar navbar-expand-lg">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a href="reservation.php" class="text-decoration-none">Reserve Table</a>
                        </li>
                        <li class="nav-item">
                            <a href="logout.php" class="text-decoration-none" onclick="return confirmLogout(event);">Logout</a>
                        </li>
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to Cafe Radiance , <?php echo $_SESSION['username']; ?>!</h3>
                <p>
        ...
        if (confirm("Are you sure you want to logout?")) {
            ...
            event.preventDefault(); // Prevent default action (logout link)
            return false;
        }
         }
